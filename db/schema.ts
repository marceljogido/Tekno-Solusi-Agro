...
export const mediaLocations = pgTable("media_locations", {
  ...
  panjangLahan: decimal("panjang_lahan", { precision: 10, scale: 2 }),
  lebarLahan: decimal("lebar_lahan", { precision: 10, scale: 2 }),
  lebarLegowo: decimal("lebar_legowo", { precision: 10, scale: 2 }),
  jarakAntarTanaman: decimal("jarak_antar_tanaman", { precision: 10, scale: 2 }),
  jarakAntarBaris: decimal("jarak_antar_baris", { precision: 10, scale: 2 }),
  jumlahBarisPerLegowo: integer("jumlah_baris_per_legowo"),
  luasTotalBedengan: decimal("luas_total_bedengan", { precision: 15, scale: 4 }),
  luasTotalJajarLegowo: decimal("luas_total_jajar_legowo", { precision: 15, scale: 4 }),
  pricePerM2: decimal("price_per_m2", { precision: 15, scale: 2 }),
